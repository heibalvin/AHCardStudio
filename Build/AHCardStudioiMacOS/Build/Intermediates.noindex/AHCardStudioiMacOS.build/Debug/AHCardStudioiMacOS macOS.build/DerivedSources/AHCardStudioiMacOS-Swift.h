...
#ifndef AHCARDSTUDIOIMACOS_SWIFT_H
#define AHCARDSTUDIOIMACOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AHCardStudioiMacOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
SWIFT_CLASS("_TtC18AHCardStudioiMacOS15AHKlondikeScene")
@interface AHKlondikeScene : SKScene
...
@class NSApplication;
SWIFT_CLASS("_TtC18AHCardStudioiMacOS11AppDelegate")
...
@class SKView;
SWIFT_CLASS("_TtC18AHCardStudioiMacOS9GameScene")
...
@class NSEvent;
@interface GameScene (SWIFT_EXTENSION(AHCardStudioiMacOS))
...
@class NSBundle;
SWIFT_CLASS("_TtC18AHCardStudioiMacOS18GameViewController")
